...
class VHFNavaid():
    ...
    def read_primary(self, r):
        ...
        fields.append(["Section Code",              r[4],       decode.text])
        fields.append(["Subsection Code",           r[5],       decode.text])
        ...
        fields.append(["Continuation Records No",   r[21],      decode.text])
        fields.append(["Frequency",                 r[22:27],   decode.freq])
        fields.append(["Class",                     r[27:32],   decode.nclass])
        fields.append(["VOR Latitude",              r[32:41],   decode.gps])
        fields.append(["VOR Longitude",             r[41:51],   decode.gps])
        fields.append(["DME Ident",                 r[51:55],   decode.text])
        fields.append(["DME Latitude",              r[55:64],   decode.gps])
        fields.append(["DME Longitude",             r[64:74],   decode.gps])
        fields.append(["Station Declination",       r[74:79],   decode.text])
        fields.append(["DME Elevation",             r[79:84],   decode.dme_el])
        fields.append(["Figure of Merit",           r[84],      decode.text])
        fields.append(["ILS/DME Bias",              r[85:87],   decode.text])
        fields.append(["Frequency Protection",      r[87:90],   decode.freq])
    ...
    def read_cont(self, r):
        fields = []
        fields.append(["Record Type",               r[0],       decode.text])
        fields.append(["Customer / Area Code",      r[1:4],     decode.text])
        fields.append(["Section Code",              r[4],       decode.text])
        fields.append(["Subsection Code",           r[5],       decode.text])
        fields.append(["Airport ICAO Identifier",   r[6:10],    decode.text])

...
class AirwayRestricted():
    ...
    def read_primary_alt_exclude(self, r):
        return [
            ...
            ("Restriction Identifier",          r[25:29],   decode.text),
            ("Restriction Type",                r[29:34],   decode.text),
            ("ICAO Code",                       r[34:36],   decode.text),
            ("Continuation Record No",          r[38],      decode.cont),
            ("Start Fix Identifier",            r[39:43],   decode.text),
            ("Start Fix ICAO Code",             r[43],      decode.text),
            ("Start Fix Section Code",          r[25:27],   decode.text),

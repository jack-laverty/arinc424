...
class Heliport():
    ...
    def read_primary(self, r):
        return [
            ...
            ("Datum Code",                  r[27:30],   decode.text),
            ("IFR Indicator",               r[30],      decode.text),
            ("Latitude",                    r[32:41],   decode.gps),
            ("Longitude",                   r[41:51],   decode.gps),
            ("Magnetic Variation",          r[51:56],   decode.text),
            ("Heliport Elevation",          r[56:61],   decode.text),
            ("Speed Limit",                 r[61:64],   decode.text),
            ("Recommended VHF Navaid",      r[64:68],   decode.text),
            ...
            ("Pad Dimensions",              r[85:91],   decode.text),
            ("Magnetic/True Indicator",     r[91],      decode.text),
            ("Heliport Name",               r[93:123],  decode.text),
    ...
    def read_flight0(self, r):
        return [
            ...
            ("Controlled A/S Airport Indentifier", r[67:71],   decode.text),

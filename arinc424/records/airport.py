...
class Airport():
    ...
    def read_primary(self, r):
        ...
        fields.append(["Longest Runway",          r[27:30],   decode.text])
        fields.append(["IFR Capability",          r[30],      decode.text])
        fields.append(["Longest Runway Surface Code",
                      r[31], decode.text])
        fields.append(["Airport Reference Pt. Latitude",
                      r[32:41], decode.gps])
        fields.append(["Airport Reference Pt. Longitude",
                      r[41:51], decode.gps])
        fields.append(["Magnetic Variation",      r[51:56],   decode.text])
        fields.append(["Airport Elevation",       r[56:61],   decode.text])
        fields.append(["Speed Limit",             r[61:64],   decode.text])
        fields.append(["Recommended Navaid",      r[64:68],   decode.text])
        ...
        fields.append(["Magnetic/True Indicator", r[85],      decode.text])
        fields.append(["Datum Code",              r[86:89],   decode.text])
        fields.append(["Airport Name",            r[93:123],  decode.text])

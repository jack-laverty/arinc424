...
class EnrouteComms():
    ...
    def read_primary(self, r):
        return {
            ...
            "Communication Altitude (2)":          r[98:103],
            "Remote Facility":                     r[103:107],
            "ICAO Code":                           r[107:109],
            "Section Code (2)":                    r[109:111],
    ...
    def read_timeop(self, r):
        return {
            ...
            "Application Type":                    r[56],
            "Time of Operation":                   r[60:70],
            "Time of Operation (2)":               r[70:80],
            "Time of Operation (3)":               r[80:90],
            "Time of Operation (4)":               r[90:100],
            "Time of Operation (5)":               r[100:110],
            "Time of Operation (6)":               r[110:120],
            "File Record No":                      r[123:128],
            "Cycle Date":                          r[128:132]
        }
